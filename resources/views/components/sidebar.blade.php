...
<div x-data="{ sidebarOpen: false }">
    ...
    <div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <div class="p-6 relative">
            ...
            <!-- Sidebar Categories -->
            <div class="space-y-2" x-data="{ categories: [
                ...
                <template x-for="category in categories" :key="category.name">
                    <div class="relative group">
                        <div class="p-3 rounded-lg neu-button flex justify-between items-center bg-white cursor-pointer">
                        ...
                        <!-- Dropdown -->
                        <div class="absolute left-full top-0 ml-2 bg-white neu-shadow rounded-lg w-48 z-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none group-hover:pointer-events-auto">
                            <ul class="py-2">
                                <template x-for="item in category.items" :key="item">
                                    <li class="px-4 py-2 hover:bg-gray-100 cursor-pointer" x-text="item"></li>
                                </template>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="mt-10 space-y-2">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="p-3 rounded-lg neu-button bg-white cursor-pointer w-full flex items-center space-x-2">
